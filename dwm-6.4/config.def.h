...
static const char *fonts[]          = { "UbuntuMono Nerd Font:style=Regular:size=11" };
static const char dmenufont[]       = "UbuntuMono Nerd Font:style=Regular:size=11";
